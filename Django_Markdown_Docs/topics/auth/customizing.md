...
By default, [`AUTHENTICATION_BACKENDS`](../../ref/settings.md#std-setting-AUTHENTICATION_BACKENDS) is set to:
...
<a id="specifying-custom-user-model"></a>
...
<a id="custom-users-and-the-built-in-auth-forms"></a>
