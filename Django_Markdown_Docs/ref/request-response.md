...
The [`url`](templates/builtins.md#std-templatetag-url) template tag will use its value as the `current_app`
...
#### HttpResponse.\_\_getitem_\_(header)
...
<a id="request-response-streaming-disconnect"></a>
