...
When [`USE_TZ`](../settings.md#std-setting-USE_TZ) is `True` then datetimes are stored in the database
...
Calculates the leading value in a given [frame](expressions.md#window-frames). Both
