...
See the [Django 4.0 release notes](../releases/4.0.md#deprecated-features-4-0) for more
details on these changes.
...
See the [Django 2.1 release notes](../releases/2.1.md#deprecated-features-2-1) for more
details on these changes.
