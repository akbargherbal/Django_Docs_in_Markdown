...
### Acquiring the token if [`CSRF_USE_SESSIONS`](../ref/settings.md#std-setting-CSRF_USE_SESSIONS) or [`CSRF_COOKIE_HTTPONLY`](../ref/settings.md#std-setting-CSRF_COOKIE_HTTPONLY) is `True`
